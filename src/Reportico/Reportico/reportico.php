...
class reportico extends reportico_object
{
    ...
    */
	...
	function initialize_panels($mode)
	{
		...
		// ***MENUURL ***if (array_key_exists("menu_url", \Session::get(reportico_namespace())))
		// ***MENUURL ***{
	...
	function handle_xml_query_input($mode=false)
	{
		...
		//if ( $mode == "MENU" && array_key_exists("xmlin", \Session::get(reportico_namespace())) )
		{
			unset_reportico_session_param("xmlin");
		}

        if ( $mode == "ADMIN" && isset_reportico_session_param("xmlin")  )
		//if ( $mode == "ADMIN" && array_key_exists("xmlin", \Session::get(reportico_namespace())) )
		{
			unset_reportico_session_param("xmlin");
		}
		...
		//if ( array_key_exists("xmlin", \Session::get(reportico_namespace())) )
		{
		...
		//if ( array_key_exists("sqlin", \Session::get(reportico_namespace())) )
		{
		...
		//if ( array_key_exists("template", \Session::get(reportico_namespace())) )
		{
		...
		//if ( array_key_exists("xmlout", \Session::get(reportico_namespace())) )
		{
